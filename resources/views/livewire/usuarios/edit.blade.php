...
new #[Layout('layouts.app')] class extends Component
{
    ...
    {
        $this->id = $id;
        $user = User::with('roles', 'sucursales')->findOrFail($id);
        $this->name = $user->name;
        ...
        $this->sucursales = $user->sucursales->pluck('id')->toArray();
    }
            ...
            <form wire:submit="save" class="space-y-6">
                ...
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model="activo" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">
